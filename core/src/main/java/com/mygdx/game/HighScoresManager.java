...
public class HighScoresManager {
    ...
    public List<Integer> getHighScores() {
        return GameSettings.isEasyMode() ? 
               new ArrayList<>(easyHighScores) : 
               new ArrayList<>(hardHighScores);
    }
    ...
    /**
     * Gets the current best score for the selected difficulty, or 0 if no scores exist
     */
     ...
     * @param difficulty The difficulty to clear (GameSettings.DIFFICULTY_EASY or DIFFICULTY_HARD)
     */
