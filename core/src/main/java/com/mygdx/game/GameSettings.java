...
/**
 * Stores global game settings and constants
 */
public class GameSettings {
     ...
     * @param difficulty The difficulty level (use constants DIFFICULTY_EASY or DIFFICULTY_HARD)
     */
     ...
     * @return The current difficulty (DIFFICULTY_EASY or DIFFICULTY_HARD)
     */
